...
- The monotonic model could be operate two ways. One is the direct effect of peers e.g. high-achieving peers can help learning in the classroom. What is an indirect way the monotonic model could work? Hint: who else is in the classroom?
