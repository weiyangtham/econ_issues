...
- Imagine you received the following data. What would be the problem with using this result to claim that laptops hurt learning?
...
## Terminology
-  that we cannot observe in the data and that could affect both the explanatory variable (using a laptop or not) and the outcome variable (grades)
